...
// const MypageUserEdit = () => {
//     const { userId,user,setUserId } = useContext(AdminFlagContext); // AdminFlagContext에서 필요한 값(userId 등)을 가져옵니다.
//     const [nickname, setNickname] = useState('');
//     const [userInfo, setUserInfo] = useState('');
//     const [oldPassword, setOldPassword] = useState('');
//     const [newPassword, setNewPassword] = useState('');
...
//         // 기존 닉네임과 새로운 닉네임 비교
//         if (userInfo.name === nickname) {
//             setMessage('기존 닉네임과 새 닉네임이 같습니다. 다른 닉네임을 입력해주세요.');
//             return;
//         }
